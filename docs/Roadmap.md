...
- Documentação (Charter, Vision, Principles, Manifesto, GDD, UX Bible, Glossary, Game Domain Model)
...
Tudo que estiver em [Backlog.md](Backlog.md) só entra em roadmap após a Fase 2.
