...
> Direção de arte e identidade visual **não** são decididas por Claude (ver [CLAUDE.md](../CLAUDE.md) — "Papel do Claude"). Este documento é um placeholder até que essas decisões sejam fornecidas pelo produto.
